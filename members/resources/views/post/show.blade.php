            ...
            <div class="px-10 mt-4">
                ...
                <div class="bg-white w-full  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
                    ...
                    <div class="flex justify-end mt-4">
                        ...
                        @csrf
                        @method('delete')
                            <x-primary-button class="bg-red-700 float-right ml-4" onClick="return confirm('まじで削除しますか？');">削除</x-primary-button>
                        </form>
                    </div>
                    ...
                    <div class="bg-white w-full  rounded-2xl px-10 py-1 shadow-lg mt-8 whitespace-pre-line">
                        {{$comment->body}}
                        <div class="text-sm font-semibold flex flex-row-reverse">
